...
"""
The model implementation is adapted from the WAE implementation in: https://github.com/AntixK/PyTorch-VAE/blob/master/models/wae_mmd.py
"""
...
class WAE_MMD(BaseVAE):
    ...
    def get_latent_features(self, x: Tensor) -> Tensor:
        """
        Given an input image x, returns the latent features of the vector z
        :param x: (Tensor) [B x C x H x W]
        :return: (Tensor) [B x D]
        """
